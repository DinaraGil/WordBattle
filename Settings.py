...
class Settings:
    ...
    ALICE_ID = 1
    USERNAME = 'Вы'
    HELP_MESSAGE = 'Вы запустили навык "Заклинатель слов". Правила игры: мы по очереди атакуем друг друга словами. ' \
           ...
           'Слово должно быть существительным, в начальной форме. Для повторения правил скажите "Помощь".'
